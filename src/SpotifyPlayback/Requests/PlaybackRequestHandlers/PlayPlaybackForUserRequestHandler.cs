...
{
    public class PlayPlaybackForUserRequestHandler : IPlaybackRequestHandler<PlayPlaybackForUserRequest, PlaybackRequestResult<PlayPlaybackForUserRequestResult>>
    {
        ...
        public PlayPlaybackForUserRequestHandler(ISocketDirector socketDirector, IPlaybackGroupCollection playbackGroupCollection, ISpotifyPlaybackService spotifyPlaybackService)
        {
        ...
        public Task<PlaybackRequestResult<PlayPlaybackForUserRequestResult>> HandleAsync(PlayPlaybackForUserRequest request)
        {
            ...
            return Task.FromResult(
                PlaybackRequestResult.Success(new PlayPlaybackForUserRequestResult(), "User joined group successfully"));
        }
    }
