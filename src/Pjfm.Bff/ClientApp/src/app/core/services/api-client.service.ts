...
export class SessionGroupClient {
    ...
    getParticipants(groupId: string | null): Observable<ApplicationUserDto[]> {
    ...
    protected processGetParticipants(response: HttpResponseBase): Observable<ApplicationUserDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class UserClient {
    ...
    autocomplete(query: string | null | undefined, limit: number | undefined): Observable<ApplicationUserDto[]> {
    ...
    protected processAutocomplete(response: HttpResponseBase): Observable<ApplicationUserDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
