...
export class AuthenticationClient {
  ...
  logout(logoutId: string | null | undefined): Observable<void> {
    ...
    if (logoutId !== undefined && logoutId !== null) url_ += 'logoutId=' + encodeURIComponent('' + logoutId) + '&';
    url_ = url_.replace(/[?&]$/, '');
...
export class PlaybackClient {
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return <Observable<PlaybackGroupDto[]>>(<any>_observableThrow(response_));
        }),
      );
  }
      ...
      return blobToText(responseBlob).pipe(
        _observableMergeMap((_responseText) => {
          ...
          if (Array.isArray(resultData200)) {
            result200 = [] as any;
            for (let item of resultData200) result200!.push(PlaybackGroupDto.fromJS(item));
          } else {
            result200 = <any>null;
          }
  ...
  play(deviceId: string | null | undefined, groupId: string): Observable<void> {
    ...
    if (deviceId !== undefined && deviceId !== null) url_ += 'deviceId=' + encodeURIComponent('' + deviceId) + '&';
    url_ = url_.replace(/[?&]$/, '');
...
export class SpotifyAuthenticationClient {
  ...
  callback(state: string | null | undefined, code: string | null | undefined): Observable<string> {
    ...
    if (state !== undefined && state !== null) url_ += 'state=' + encodeURIComponent('' + state) + '&';
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return <Observable<GetDevicesResponse>>(<any>_observableThrow(response_));
        }),
      );
  }
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return <Observable<SearchTracksResult>>(<any>_observableThrow(response_));
        }),
      );
  }
...
export class UserClient {
  ...
  constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
    this.http = http;
    this.baseUrl = baseUrl != null ? baseUrl : 'https://localhost:5004';
  }
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return <Observable<GetCurrentUserResponseModel>>(<any>_observableThrow(response_));
        }),
      );
  }
...
export class PlaybackGroupDto implements IPlaybackGroupDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['queuedTracks'])) {
        ...
        for (let item of _data['queuedTracks']) this.queuedTracks!.push(SpotifyTrackDto.fromJS(item));
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.queuedTracks)) {
      data['queuedTracks'] = [];
      for (let item of this.queuedTracks) data['queuedTracks'].push(item.toJSON());
    }
...
export class SpotifyTrackDto implements ISpotifyTrackDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['artists'])) {
        this.artists = [] as any;
        for (let item of _data['artists']) this.artists!.push(item);
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.artists)) {
      data['artists'] = [];
      for (let item of this.artists) data['artists'].push(item);
    }
...
export class PlaybackTrackRequest implements IPlaybackTrackRequest {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['trackIds'])) {
        ...
        for (let item of _data['trackIds']) this.trackIds!.push(item);
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.trackIds)) {
      data['trackIds'] = [];
      for (let item of this.trackIds) data['trackIds'].push(item);
    }
    return data;
  }
}
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['devices'])) {
        this.devices = [] as any;
        for (let item of _data['devices']) this.devices!.push(DeviceModel.fromJS(item));
      }
    }
  }
...
export class SearchTracksResult implements ISearchTracksResult {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['tracks'])) {
        this.tracks = [] as any;
        for (let item of _data['tracks']) this.tracks!.push(SpotifyTrackDto.fromJS(item));
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.tracks)) {
      data['tracks'] = [];
      for (let item of this.tracks) data['tracks'].push(item.toJSON());
    }
    return data;
  }
}
