...
namespace Pjfm.Infrastructure.Migrations.Application
{
    ...
    [Migration("20220315152654_SessionGroup")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserSessionGroup", b =>
                {
                    b.Property<string>("FillerQueueParticipantGroupsId")
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("FillerQueueParticipantsId")
                        .HasColumnType("nvarchar(50)");

                    b.HasKey("FillerQueueParticipantGroupsId", "FillerQueueParticipantsId");

                    b.HasIndex("FillerQueueParticipantsId");

                    b.ToTable("ApplicationUserSessionGroup");
                });
            ...
            modelBuilder.Entity("Domain.SessionGroup.SessionGroup", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("ApplicationUserSessionGroup", b =>
                {
                    b.HasOne("Domain.SessionGroup.SessionGroup", null)
                        .WithMany()
                        .HasForeignKey("FillerQueueParticipantGroupsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.ApplicationUser.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("FillerQueueParticipantsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Domain.SpotifyUserData.SpotifyUserData", b =>
                {
                    b.HasOne("Domain.ApplicationUser.ApplicationUser", "ApplicationUser")
                        .WithOne("SpotifyUserData")
                        .HasForeignKey("Domain.SpotifyUserData.SpotifyUserData", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
